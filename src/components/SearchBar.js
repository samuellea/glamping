...
class SearchBar extends Component {
    ...
    return (
      <Row className="searchBar">
          ...
          <div className="borderBox">
            ...
            >
              ...
              <Dropdown.Menu style={{ width: '100%' }}>
                <Dropdown.Item onClick={() => locationClicker('Any Location')}>
                  Any Location
                </Dropdown.Item>
                <Dropdown.Divider />
                <Dropdown.Item onClick={() => locationClicker('England')}>
                  England
                </Dropdown.Item>
                <Dropdown.Item onClick={() => locationClicker('Scotland')}>
                  Scotland
                </Dropdown.Item>
                <Dropdown.Item onClick={() => locationClicker('Wales')}>
                  Wales
                </Dropdown.Item>
                <Dropdown.Item onClick={() => locationClicker('Ireland')}>
                  Ireland
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
            ...
            <div className="calendarInput">
              <div className="left">
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    <DayPicker
                      month={new Date(2025, this.state.checkInMonth)}
            ...
            <div className="calendarInput">
              <div className="left">
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    <DayPicker
                      month={new Date(2025, this.state.checkOutMonth)}
        ...
        <Col xs={6} md={3} className="findButton">
          <Button
            className="greenButton searchButton"
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const monthChange =
      prevState.checkInMonth !== this.state.checkInMonth ||
      prevState.checkOutMonth !== this.state.checkOutMonth;
    if (monthChange) {
      this.setState({
